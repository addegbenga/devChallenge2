            ...
            {!loading && weatherdata ? (
              weatherdata.slice(1).map((item, i) => (
                <div
                  ...
                  key={i}
                  className="select-none flex bg-custom_bg-secondary flex-col  md:flex-grow hover:border-custom_border-hover transition duration-300 ease-in-out transform  items-center p-2 "
                >
